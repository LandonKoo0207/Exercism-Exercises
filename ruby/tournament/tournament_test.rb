...
class TournamentTest < Minitest::Test
  def test_just_the_header_if_no_input
    ...
    puts "input:!!! #{Tournament.tally(input).length}, #{expected.length}"
  ...
  def test_a_win_is_three_points_a_loss_is_zero_points
    ...
    puts "expected: #{expected.length}, actual: #{Tournament.tally(input).length}"
  ...
  def test_a_draw_is_one_point_each
    ...
    puts expected == Tournament.tally(input)

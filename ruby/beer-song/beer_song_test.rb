...
class BeerSongTest < Minitest::Test
  def test_first_generic_verse
    ...
    puts "#{expected}:#{expected.length} \n #{BeerSong.recite(99, 1)}:#{BeerSong.recite(99, 1).length}"
  ...
  def test_first_two_verses
    ...
    puts "#{expected}: #{expected.length}, #{BeerSong.recite(99, 2)}: #{BeerSong.recite(99,2).length}"
